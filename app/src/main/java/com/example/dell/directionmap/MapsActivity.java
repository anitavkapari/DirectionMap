package com.example.dell.directionmap;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                if (listPoint.size()==2){
                    //create the URL to get request from first marker to secound marker
    ...
    public class TaskParse extends AsyncTask<String , Void, List<List<HashMap<String, String>>>>{
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> lists) {
            //get route and display it into the map
